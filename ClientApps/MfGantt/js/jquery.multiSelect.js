...
if(jQuery) (function($){
	...
	function updateSelected() {
		...
		var selectAll = true;
		var display = '';
		multiSelectOptions.find('label').not('.selectAll, .optGroup').each( function() {
		...
		/*
		display = $.map(multiSelectOptions.find("label.checked"), function(v) {
						return $(v).text()
					}).join(", ");	
		*/
	...
	$.extend($.fn, {
		multiSelect: function(o, callback) {
			...
			$(this).each( function() {
				...
				html += '<div class="multiSelectOptions" style="position: absolute; z-index: 99999;"></div>';
				$(select).after(html);
		...
		multiSelectOptionsHide: function() {
			$(this).removeClass('active').removeClass('hover').next('.multiSelectOptions').hide();
		},
		...
		multiSelectOptionsShow: function() {
			...
			multiSelect.addClass('active').next('.multiSelectOptions').show();
			multiSelect.focus();
		...
		selectedValuesString: function() {
			var selectedValues = "";
			$(this).next('.multiSelectOptions').find(':checked').not('.optGroup, .selectAll').each(function() {
