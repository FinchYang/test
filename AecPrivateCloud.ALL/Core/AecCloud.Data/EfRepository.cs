...
namespace AecCloud.Data
{
    ...
    public class EfRepository<T> : IRepository<T> where T : Entity
    {
        ...
        public EfRepository(IDbContext cxt)
        {
            _context = cxt;
        }
        ...
        public virtual void Insert(T entity)
        {
            ...
            {
             //   Writelog("db insert error: in catch");
             ...
             //   Writelog("db insert error: " + msg + dbEx.Message);
                throw fail;
            }
            catch (Exception ex)
            {
             //   Writelog(string.Format("db insert error:  public virtual void Insert(T entity),{0}",ex.Message));
                throw;
            }
        }
