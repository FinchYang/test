...
#define MyAppName "DBWorldClient"
#define MyAppVersion "2.4.1.5"
#define MyAppPublisher "CADSimula, Inc."
#define MyAppURL "http://www.dbworld.cn/"
#define MyAppExeName "CSCEC82Client.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{31E79F64-6905-4522-BB54-246D5D782806}
AppName={#MyAppName}
...
AllowNoIcons=yes
OutputDir=.
OutputBaseFilename=DBWorld Setup
SetupIconFile=..\AecCloud.Client\logo.ico
Compression=lzma
SolidCompression=yes
ArchitecturesInstallIn64BitMode=x64

[Registry]
Root: HKCU; Subkey: "Software\{#MyAppName}\Client"; ValueType: string; ValueName: "CONFIG"; ValueData: "{userdocs}\{#MyAppName}"; Flags: uninsdeletevalue
...
[Files]
Source: "..\..\bin\release\Client\*.exe"; DestDir: "{app}"; Flags: ignoreversion 
Source: "..\..\bin\release\Client\*.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\bin\release\Client\*.config"; DestDir: "{app}"; Flags: ignoreversion
;Source: "{tmp}\RevitPlugin\*"; DestDir: "{app}\RevitPlugin\"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: F:\dev tools\NDP451-KB2858728-x86-x64.3505182529.exe; DestDir: "{tmp}"; Flags: ignoreversion 
...
begin
    if not IsDotNetDetected('v4.5', 0) then begin
      if MsgBox('.NET Framework版本过低，DBWorld需要安装新版本的.NET Framework？', mbConfirmation, MB_YESNO or MB_DEFBUTTON1) = IDYES then begin
        // yes
        ExtractTemporaryFile('NDP451-KB2858728-x86-x64.3505182529.exe');  
        Exec(ExpandConstant('{tmp}/NDP451-KB2858728-x86-x64.3505182529.exe'), '', '', SW_SHOWNORMAL, ewWaitUntilTerminated, ResultCode); 
