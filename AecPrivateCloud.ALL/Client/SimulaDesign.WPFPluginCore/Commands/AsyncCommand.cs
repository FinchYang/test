...
namespace SimulaDesign.WPFPluginCore.Commands
{
    ...
    public class AsyncCommand<TResult> : AsyncCommandBase, INotifyPropertyChanged
    {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            if (!Execution.IsCompleted) await Execution.TaskCompletion;
    ...
    public static class AsyncCommand
    {
        ...
        {
            return new AsyncCommand<object>(async _ => { await command(); return Task.FromResult<object>(null); });
        }
