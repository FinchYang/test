...
(function (u, undefined) {
    ...
    var meetNotice = {//会议通知
        typeAlias: 'ObjInfoNotice',
        classAlias: 'ClassMeetingNotice',
        ownerAlias: null,
        propDefs: {
            NameOrTitle: "0", //名称或标题
            Content: "PropInfoContent", //正文
            MeetingDate: "PropMeetingDate", //会议日期
            MeetingPlace: "PropMeetingPlace", //会议地点
            NoticeUsers: "PropNoticeUsers", //通知对象
            IsRead: "PropIsRead" //已读？
        }
    };
    var infoNotice = {//一般通知
        typeAlias: 'ObjInfoNotice',
    ...
    u.meetNotice = meetNotice;//会议通知
    u.infoNotice = infoNotice;//一般通知
})(md);